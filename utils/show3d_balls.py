...
path = "C:/Users/bryan/Downloads/pointnet.pytorch/utils"
name = "render_balls_so.so"
...
# dll = ct.CDLL((path + "/" + name), winmode=0)
# dll = np.ctypeslib.load_library('render_balls_so.so', 'C:/Users/bryan/Downloads/pointnet.pytorch/utils')

dll = ct.windll.LoadLibrary("C:/Users/bryan/Downloads/pointnet.pytorch/utils/render_balls_so.so")
